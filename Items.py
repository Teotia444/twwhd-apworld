...
ITEM_TABLE: dict[str, TWWHDItemData] = {
  ...
  # "Boat's Sail":               TWWHDItemData("Item",      IC.progression,                  1,  1, 0x78),  # noqa: E131
    ...
    "Triforce Chart 2":          TWWHDItemData("Item",      IC.progression_skip_balancing,  64,  1, 0xFC),
    "Triforce Chart 3":          TWWHDItemData("Item",      IC.progression_skip_balancing,  65,  1, 0xFA),
    "Treasure Chart 1":          TWWHDItemData("Item",      IC.progression_skip_balancing,  66,  1, 0xE7),
    "Treasure Chart 2":          TWWHDItemData("Item",      IC.progression_skip_balancing,  67,  1, 0xEE),
    "Treasure Chart 3":          TWWHDItemData("Item",      IC.progression_skip_balancing,  68,  1, 0xE0),
    "Treasure Chart 4":          TWWHDItemData("Item",      IC.progression_skip_balancing,  69,  1, 0xE1),
    "Treasure Chart 5":          TWWHDItemData("Item",      IC.progression_skip_balancing,  70,  1, 0xF2),
    "Treasure Chart 6":          TWWHDItemData("Item",      IC.progression_skip_balancing,  71,  1, 0xEA),
    "Treasure Chart 7":          TWWHDItemData("Item",      IC.progression_skip_balancing,  72,  1, 0xCC),
    "Treasure Chart 8":          TWWHDItemData("Item",      IC.progression_skip_balancing,  73,  1, 0xD4),
    "Treasure Chart 9":          TWWHDItemData("Item",      IC.progression_skip_balancing,  74,  1, 0xDA),
    "Treasure Chart 10":         TWWHDItemData("Item",      IC.progression_skip_balancing,  75,  1, 0xDE),
    "Treasure Chart 11":         TWWHDItemData("Item",      IC.progression_skip_balancing,  76,  1, 0xF6),
    "Treasure Chart 12":         TWWHDItemData("Item",      IC.progression_skip_balancing,  77,  1, 0xE9),
    "Treasure Chart 13":         TWWHDItemData("Item",      IC.progression_skip_balancing,  78,  1, 0xCF),
    "Treasure Chart 14":         TWWHDItemData("Item",      IC.progression_skip_balancing,  79,  1, 0xDD),
    "Treasure Chart 15":         TWWHDItemData("Item",      IC.progression_skip_balancing,  80,  1, 0xF5),
    "Treasure Chart 16":         TWWHDItemData("Item",      IC.progression_skip_balancing,  81,  1, 0xE3),
    "Treasure Chart 17":         TWWHDItemData("Item",      IC.progression_skip_balancing,  82,  1, 0xD7),
    "Treasure Chart 18":         TWWHDItemData("Item",      IC.progression_skip_balancing,  83,  1, 0xE4),
    "Treasure Chart 19":         TWWHDItemData("Item",      IC.progression_skip_balancing,  84,  1, 0xD1),
    "Treasure Chart 20":         TWWHDItemData("Item",      IC.progression_skip_balancing,  85,  1, 0xF3),
    "Treasure Chart 21":         TWWHDItemData("Item",      IC.progression_skip_balancing,  86,  1, 0xCE),
    "Treasure Chart 22":         TWWHDItemData("Item",      IC.progression_skip_balancing,  87,  1, 0xD9),
    "Treasure Chart 23":         TWWHDItemData("Item",      IC.progression_skip_balancing,  88,  1, 0xF1),
    "Treasure Chart 24":         TWWHDItemData("Item",      IC.progression_skip_balancing,  89,  1, 0xEB),
    "Treasure Chart 25":         TWWHDItemData("Item",      IC.progression_skip_balancing,  90,  1, 0xD6),
    "Treasure Chart 26":         TWWHDItemData("Item",      IC.progression_skip_balancing,  91,  1, 0xD3),
    "Treasure Chart 27":         TWWHDItemData("Item",      IC.progression_skip_balancing,  92,  1, 0xCD),
    "Treasure Chart 28":         TWWHDItemData("Item",      IC.progression_skip_balancing,  93,  1, 0xE2),
    "Treasure Chart 29":         TWWHDItemData("Item",      IC.progression_skip_balancing,  94,  1, 0xE6),
    "Treasure Chart 30":         TWWHDItemData("Item",      IC.progression_skip_balancing,  95,  1, 0xF4),
    "Treasure Chart 31":         TWWHDItemData("Item",      IC.progression_skip_balancing,  96,  1, 0xF0),
    "Treasure Chart 32":         TWWHDItemData("Item",      IC.progression_skip_balancing,  97,  1, 0xD0),
    "Treasure Chart 33":         TWWHDItemData("Item",      IC.progression_skip_balancing,  98,  1, 0xEF),
    "Treasure Chart 34":         TWWHDItemData("Item",      IC.progression_skip_balancing,  99,  1, 0xE5),
    "Treasure Chart 35":         TWWHDItemData("Item",      IC.progression_skip_balancing, 100,  1, 0xE8),
    "Treasure Chart 36":         TWWHDItemData("Item",      IC.progression_skip_balancing, 101,  1, 0xD8),
    "Treasure Chart 37":         TWWHDItemData("Item",      IC.progression_skip_balancing, 102,  1, 0xD5),
    "Treasure Chart 38":         TWWHDItemData("Item",      IC.progression_skip_balancing, 103,  1, 0xED),
    "Treasure Chart 39":         TWWHDItemData("Item",      IC.progression_skip_balancing, 104,  1, 0xEC),
    "Treasure Chart 40":         TWWHDItemData("Item",      IC.progression_skip_balancing, 105,  1, 0xDF),
    "Treasure Chart 41":         TWWHDItemData("Item",      IC.progression_skip_balancing, 106,  1, 0xD2),
    "Treasure Chart 42":         TWWHDItemData("Item",      IC.progression_skip_balancing, 107,  1, 0xFD),
    "Treasure Chart 43":         TWWHDItemData("Item",      IC.progression_skip_balancing, 108,  1, 0xFB),
    "Treasure Chart 44":         TWWHDItemData("Item",      IC.progression_skip_balancing, 109,  1, 0xF9),
    "Treasure Chart 45":         TWWHDItemData("Item",      IC.progression_skip_balancing, 110,  1, 0xF8),
    "Treasure Chart 46":         TWWHDItemData("Item",      IC.progression_skip_balancing, 111,  1, 0xF7),
