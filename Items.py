...
ITEM_TABLE: dict[str, TWWHDItemData] = {
  ...
  # "Boat's Sail":               TWWHDItemData("Item",      IC.progression,                  1,  1, 0x78),  # noqa: E131
    ...
    "Treasure Chart 42":         TWWHDItemData("Item",      IC.progression_skip_balancing, 111,  1, 0xFD),
    "Treasure Chart 43":         TWWHDItemData("Item",      IC.progression_skip_balancing, 111,  1, 0xFB),
    "Treasure Chart 44":         TWWHDItemData("Item",      IC.progression_skip_balancing, 111,  1, 0xF9),
    "Treasure Chart 45":         TWWHDItemData("Item",      IC.progression_skip_balancing, 111,  1, 0xF8),
