...
ITEM_TABLE: dict[str, TWWHDItemData] = {
  ...
  # "Boat's Sail":               TWWHDItemData("Item",      IC.progression,                  1,  1, 0x78),  # noqa: E131
    ...
    "Triforce Chart 4":          TWWHDItemData("Item",      IC.progression_skip_balancing,  66,  1, 0xFB),
    "Triforce Chart 5":          TWWHDItemData("Item",      IC.progression_skip_balancing,  67,  1, 0xFA),
    "Triforce Chart 6":          TWWHDItemData("Item",      IC.progression_skip_balancing,  68,  1, 0xF9),
    "Triforce Chart 7":          TWWHDItemData("Item",      IC.progression_skip_balancing,  69,  1, 0xF8),
    "Triforce Chart 8":          TWWHDItemData("Item",      IC.progression_skip_balancing,  70,  1, 0xF7),
