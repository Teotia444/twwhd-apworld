...
VANILLA_DUNGEON_ITEM_LOCATIONS: dict[str, list[str]] = {
    ...
    "Dragon Roost Cavern Big Key":  ["Dragon Roost Cavern - Big Key Chest"],
    "Forbidden Woods Big Key":   ["Forbidden Woods - Big Key Chest"],
    "Tower of the Gods Big Key": ["Tower of the Gods - Big Key Chest"],
    "Earth Temple Big Key":   ["Earth Temple - Big Key Chest"],
    "Wind Temple Big Key":   ["Wind Temple - Big Key Chest"],

    "Dragon Roost Cavern Dungeon Map":  ["Dragon Roost Cavern - Water Jug Alcove Chest"],
    "Forbidden Woods Dungeon Map":   ["Forbidden Woods - First Room Chest"],
    "Tower of the Gods Dungeon Map": ["Tower of the Gods - Chest Behind Bombable Wall"],
    "Forsaken Fortress Dungeon Map":   ["Forsaken Fortress - Chest Outside Upper Jail Cell"],
    "Earth Temple Dungeon Map":   ["Earth Temple - Warp Pot Room Chest"],
    "Wind Temple Dungeon Map":   ["Wind Temple - Cyclones Room Chest"],

    "Dragon Roost Cavern Compass":  ["Dragon Roost Cavern - Rat Room Chest"],
    "Forbidden Woods Compass":   ["Forbidden Woods - Vine Maze Left Chest"],
    "Tower of the Gods Compass": ["Tower of the Gods - Skull Room Chest"],
    "Forsaken Fortress Compass":   ["Forsaken Fortress - Chest Guarded By Bokoblin"],
    "Earth Temple Compass":   ["Earth Temple - Three Blocks Room Chest"],
    "Wind Temple Compass":   ["Wind Temple - Hub Room Center Chest"],
}


def generate_itempool(world: "TWWHDWorld") -> None:
    """
...
def get_pool_core(world: "TWWHDWorld") -> tuple[list[str], list[str]]:
    """
...
def handle_dungeon_items(world: "TWWHDWorld") -> None:
    """
